...
# Shift the remaining images and write them to file
...
for iC in range(4):
    ...
    curr_img = curr_img[ROI[1] : ROI[3], ROI[0] : ROI[2]]
    print(shift)
    corrected = oic_toolkit.register.shift_image(curr_img, shift["shift"])
